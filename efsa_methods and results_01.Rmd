...
# Research design
We empirically examine these hypotheses in relation the European Food Safety Authority (EFSA), and specifically its decisions about the safety of pesticides. We conducted an experiment, which was embedded in a survey among various external stakeholders of EFSA, as detailed below. The employment of an experimental design enables us to rigorously examine the causal effects of perceived independence and prior standpoints on regulatory credibility. At the same time, by surveying real stakeholders about actual regulatory decisions of the agency, we ensure the study's generalizability to real world setting. 

While experiments have been used by Public Administration scholars to explore the perceptions of citizens and political representatives about public agencies (e.g. ###), to the best of our knowledge, this is the first study to experimentally examine the factors that shape the perceptions of stakeholders and interest groups members about agencies' decisions. In addition, this is the first study to manipulate agencies perceived independence from political stakeholders.  

<br>

## *Data collection*

The participants were selected from three sources. The first two sourses are documents of EFSA's meetings with stakeholders and lists of registerred stakeholders. These sources, which obtained from EFSA's website, include representatives of the food industry, NGOs and advocacy groups, and other relevant organizations of research and practice. We supplemented these two sources with the *Transparency Register* of the EU (http://ec.europa.eu/transparencyregister), which includes information on organisations representing particular interests at EU level, and details of their "Person with legal responsibility" and "Person in charge of EU relations". In order to focus on potential stakeholders of EFSA, we filterred the transparency register dataset, based on organizations' self-reporting of their goals, activities and fields on interest. Based on these three sources we managed to gather details of XX relevant persons from XX different organizations. Thereafter, we searched the web for email addersses of these persons, and thus we managed to find addresses of XX persons (XX%).Further details is available in the supplementary appendix [TBA].         

register and up-to-date information about those interests which includes  available in the agency's website. 
are members of stakeholder organizations    
