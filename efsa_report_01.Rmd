...
tmod3 <- lm(independence.polit.efsa ~ treatment*credibility.efsa.pre,efsa_00)
tmod4 <- lm(independence.polit.efsa ~ treatment*supports.pesticides,efsa_00)
...
tab_model(tmod1,
          ...
          collapse.se = T,
          dv.labels = rep(" ",5),
          title = "Perceived independence of EFSA from politicians")
