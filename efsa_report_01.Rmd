...
<br>
```{r, fig.width=6}
ggplot(efsa_00,aes(organization.type.short,prior.beliefs.food))+
  geom_boxplot(width = 0.5,
               outlier.colour = "white")+  
  geom_jitter(width = 0.2, height = 0,size=1,colour="dodgerblue2",alpha=0.6)+
    stat_summary(fun.data = mean_cl_normal, geom = "errorbar", colour = "red",alpha=0.5,width=0.1,size=1) + 
  stat_summary(fun.y = mean, geom = "point", colour = "red",alpha=0.5,size=2)+
  xlab("Organization type")+
  scale_y_continuous(name="Index - prior beliefs about food industry",limits = c(-6,6),breaks = -5:5)+
  coord_flip()+
  theme_tufte()
...
<br>
```{r, fig.width=6}
ggplot(efsa_00,aes(organization.type.short,supports.pesticides))+
  geom_boxplot(width = 0.5,
               outlier.colour = "white")+  
  geom_jitter(width = 0.2, height = 0.2,size=1,colour="dodgerblue2",alpha=0.6)+
    stat_summary(fun.data = mean_cl_normal, geom = "errorbar", colour = "red",alpha=0.5,width=0.1,size=1) + 
  stat_summary(fun.y = mean, geom = "point", colour = "red",alpha=0.5,size=2)+
 xlab("Organization type")+
  scale_y_continuous(name="Supports pesticides",limits = c(-6,6),breaks = -5:5)+
  coord_flip()+
  theme_tufte()
...
<br>
```{r, fig.width=6}
ggplot(efsa_00,aes(organization.type.short,greediness.food.industry))+
  geom_boxplot(width = 0.5,
               outlier.colour = "white")+  
  geom_jitter(width = 0.2, height = 0.2,size=1,colour="dodgerblue2",alpha=0.6)+
    stat_summary(fun.data = mean_cl_normal, geom = "errorbar", colour = "red",alpha=0.5,width=0.1,size=1) + 
  stat_summary(fun.y = mean, geom = "point", colour = "red",alpha=0.5,size=2)+
 xlab("Organization type")+
  scale_y_continuous(name="Perceived greediness of food industry",limits = c(-6,6),breaks = -5:5)+
  coord_flip()+
  theme_tufte()
...
<br>
```{r, fig.width=6}
ggplot(efsa_00,aes(organization.type.short,credibility.efsa.pre))+
  geom_boxplot(width = 0.5,
               outlier.colour = "white")+  
  geom_jitter(width = 0.2, height = 0.2,size=1,colour="dodgerblue2",alpha=0.6)+
    stat_summary(fun.data = mean_cl_normal, geom = "errorbar", colour = "red",alpha=0.5,width=0.1,size=1) + 
  stat_summary(fun.y = mean, geom = "point", colour = "red",alpha=0.5,size=2)+
 xlab("Organization type")+
  scale_y_continuous(name="EFSA credibility (pre)",limits = c(-6,6),breaks = -5:5)+
  coord_flip()+
  theme_tufte()
...
```{r, fig.width=6}
ggplot(efsa_00,aes(organization.type.short,independence.polit.efsa))+
  geom_boxplot(width = 0.5,
               outlier.colour = "white")+  
  geom_jitter(width = 0.2, height = 0.2,size=1,colour="dodgerblue2",alpha=0.6)+
      stat_summary(fun.data = mean_cl_normal, geom = "errorbar", colour = "red",alpha=0.5,width=0.1,size=1) + 
  stat_summary(fun.y = mean, geom = "point", colour = "red",alpha=0.5,size=2)+
xlab("Organization type")+
  scale_y_continuous(name="Political independence of EFSA (5=high)",limits = c(-6,6),breaks = -5:5)+
  coord_flip()+
  theme_tufte()
...
<br>
```{r, fig.width=6}
ggplot(efsa_00,aes(organization.type.short,independence.industry.efsa))+
  geom_boxplot(width = 0.5,
               outlier.colour = "white")+  
  geom_jitter(width = 0.2, height = 0.2,size=1,colour="dodgerblue2",alpha=0.6)+
    stat_summary(fun.data = mean_cl_normal, geom = "errorbar", colour = "red",alpha=0.5,width=0.1,size=1) + 
  stat_summary(fun.y = mean, geom = "point", colour = "red",alpha=0.5,size=2)+
  xlab("Organization type")+
  scale_y_continuous(name="Independence from industry (5=high)",limits = c(-6,6),breaks = -5:5)+
  coord_flip()+
  theme_tufte()
...
dwplot(list(Treat.HighRisk=model.treatment.t1.1,
            Treat.LowRisk=model.treatment.t1.2),
       vline = geom_vline(xintercept = 0, colour = "grey60", linetype = 2))+
  ggtitle("Prediction of treatment")+
  theme_tufte()


dwplot(list(HighRiskCase=model.risk.t1),
       vline = geom_vline(xintercept = 0, colour = "grey60", linetype = 2))+
...
lm(independence.polit.efsa~treatment*ban.pesticide,efsa_00) %>% 
  tab_model()
...
efsa_00 %>% 
  drop_na(independence.polit.efsa) %>% 
ggplot(aes(independence.polit.efsa,fill=factor(ban.pesticide.lab)))+ 
  geom_bar(width = 0.75,alpha=0.8)+
...
efsa_00 %>% 
  drop_na(independence.industry.efsa) %>% 
ggplot(aes(independence.industry.efsa,fill=factor(ban.pesticide.lab)))+ 
  geom_bar(width = 0.75,alpha=0.8)+
  scale_x_continuous(name="Independence from industry",limits = c(-6,6),breaks = -5:5)+
  scale_fill_manual(values = c("dodgerblue2","orange2"))+
  guides(fill=FALSE)+
...
model.pest.credibility.approve <- lm(credibility.pest.index~ 
         ...
         supports.pesticides+
         greediness.food.industry,
         data=filter(efsa_01,ban.pesticide==0))

model.pest.credibility.ban <- lm(credibility.pest.index~ 
         credibility.efsa.pre+
         supports.pesticides+
         greediness.food.industry,
         data=filter(efsa_01,ban.pesticide==1))
...
t1 %>%
  ...
  focus(ban.pesticide) %>%
ggplot(aes(rowname, ban.pesticide)) +
  geom_col(alpha=0.8,width = 0.75,fill="dodgerblue2",alpha=0.7,show.legend = F) +
  scale_y_continuous(name="correlation with ban pesticide case")+
  coord_flip()+
  theme_tufte()
```
...
```{r}
sjstats::grpmean(filter(efsa_01,ban.pesticide==0),
                 credibility.pest.index,
                 treatment,
                 out="v")
```
...
```{r}
sjstats::grpmean(filter(efsa_01,ban.pesticide==1),
                 credibility.pest.index,
                 treatment,
                 out="v")
```
...
```{r}
tmod1 <- lm(credibility.pest.index ~ treatment,efsa_01)
tmod2 <- lm(credibility.pest.index ~ treatment+ban.pesticide,efsa_01)
tmod3 <- lm(credibility.pest.index ~ treatment*ban.pesticide,efsa_01)
...
```{r}
tmod1 <- lm(credibility.pest.index ~ treatment,efsa_01)
tmod2 <- lm(credibility.pest.index ~ treatment+independence.polit.efsa,efsa_01)
...
t1 <- efsa_01 %>%
  select(independence.polit.efsa,
         ...
         supports.pesticides,
         credibility.efsa.pre,
         greediness.food.industry) %>% as.data.frame()

inter.binning(Y = "independence.polit.efsa", D = "treatment", X = "credibility.efsa.pre", data = t1, nbins = 3,na.rm = TRUE)
...
inter.binning(Y = "independence.polit.efsa", D = "treatment", X = "supports.pesticides", data = t1, nbins = 3,na.rm = TRUE)
...
inter.binning(Y = "independence.polit.efsa", D = "treatment", X = "greediness.food.industry", data = t1, nbins = 3,na.rm = TRUE)
...
```{r}
tmod1 <- lm(independence.polit.efsa ~ treatment,efsa_01)
tmod2 <- lm(independence.polit.efsa ~ treatment*organization.type.short,efsa_01)
tmod3 <- lm(independence.polit.efsa ~ treatment*credibility.efsa.pre,efsa_01)
tmod4 <- lm(independence.polit.efsa ~ treatment*supports.pesticides,efsa_01)
tmod5 <- lm(independence.polit.efsa ~ treatment*greediness.food.industry,efsa_01)
...
inter.binning(Y = "credibility.pest.considerations", D = "treatment", X = "credibility.efsa.pre", data = t1, nbins = 3,na.rm = TRUE)
...
inter.binning(Y = "credibility.pest.considerations", D = "treatment", X = "supports.pesticides", data = t1.ban, nbins = 3,na.rm = TRUE, main = "Ban pesticide")

inter.binning(Y = "credibility.pest.considerations", D = "treatment", X = "supports.pesticides", data = t1.approve, nbins = 3,na.rm = TRUE, main = "Approve pesticide")
```
...
inter.binning(Y = "credibility.pest.considerations", D = "treatment", X = "greediness.food.industry", data = t1.ban, nbins = 3,na.rm = TRUE, main = "Ban pesticide")

inter.binning(Y = "credibility.pest.considerations", D = "treatment", X = "greediness.food.industry", data = t1.approve, nbins = 3,na.rm = TRUE, main = "Approve pesticide")
...
```{r}
tmod1 <- lm(credibility.pest.considerations ~ treatment,efsa_01)
tmod2 <- lm(credibility.pest.considerations ~ treatment*organization.type.short,efsa_01)
tmod3 <- lm(credibility.pest.considerations ~ treatment*credibility.efsa.pre,efsa_01)
tmod4 <- lm(credibility.pest.considerations ~ treatment*supports.pesticides,efsa_01)
tmod5 <- lm(credibility.pest.considerations ~ treatment*greediness.food.industry,efsa_01)
...
inter.binning(Y = "credibility.pest.expertise", D = "treatment", X = "credibility.efsa.pre", data = t1, nbins = 3,na.rm = TRUE)
...
inter.binning(Y = "credibility.pest.expertise", D = "treatment", X = "supports.pesticides", data = t1.ban, nbins = 3,na.rm = TRUE, main = "Ban pesticide")


inter.binning(Y = "credibility.pest.expertise", D = "treatment", X = "supports.pesticides", data = t1.approve, nbins = 3,na.rm = TRUE, main = "Approve pesticide")
```
...
inter.binning(Y = "credibility.pest.expertise", D = "treatment", X = "greediness.food.industry", data = t1, nbins = 3,na.rm = TRUE)
...
```{r}
tmod1 <- lm(credibility.pest.expertise ~ treatment,efsa_01)
tmod2 <- lm(credibility.pest.expertise ~ treatment*organization.type.short,efsa_01)
tmod3 <- lm(credibility.pest.expertise ~ treatment*credibility.efsa.pre,efsa_01)
tmod4 <- lm(credibility.pest.expertise ~ treatment*supports.pesticides,efsa_01)
tmod5 <- lm(credibility.pest.expertise ~ treatment*greediness.food.industry,efsa_01)
...
inter.binning(Y = "credibility.pest.commitment", D = "treatment", X = "credibility.efsa.pre", data = t1, nbins = 3,na.rm = TRUE)
...
inter.binning(Y = "credibility.pest.commitment", D = "treatment", X = "supports.pesticides", data = t1.ban, nbins = 3,na.rm = TRUE, main = "Ban pesticide")


inter.binning(Y = "credibility.pest.commitment", D = "treatment", X = "supports.pesticides", data = t1.approve, nbins = 3,na.rm = TRUE, main = "Approve pesticide")
```
...
inter.binning(Y = "credibility.pest.commitment", D = "treatment", X = "greediness.food.industry", data = t1, nbins = 3,na.rm = TRUE)
...
```{r}
tmod1 <- lm(credibility.pest.commitment ~ treatment,efsa_01)
tmod2 <- lm(credibility.pest.commitment ~ treatment*organization.type.short,efsa_01)
tmod3 <- lm(credibility.pest.commitment ~ treatment*credibility.efsa.pre,efsa_01)
tmod4 <- lm(credibility.pest.commitment ~ treatment*supports.pesticides,efsa_01)
tmod5 <- lm(credibility.pest.commitment ~ treatment*greediness.food.industry,efsa_01)
