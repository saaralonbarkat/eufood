...
inter.binning(Y = "credibility.pest.considerations", D = "approve.pesticide", X = "supports.pesticides", data = t1, nbins = 5,na.rm = TRUE, main = " ")$graph +
  geom_hline(yintercept = 0, colour = "grey60", linetype = 2)+
  theme_tufte()  +
  labs(title = " ",
...
<br>
```{r}
inter.binning(Y = "credibility.pest.expertise", D = "approve.pesticide", X = "supports.pesticides", data = t1, nbins = 5,na.rm = TRUE, main = " ")$graph +
  geom_hline(yintercept = 0, colour = "grey60", linetype = 2)+
  theme_tufte()  +
  labs(title = " ",
              subtitle = "Expertise",
...
<br>
```{r}
inter.binning(Y = "credibility.pest.commitment", D = "approve.pesticide", X = "supports.pesticides", data = t1, nbins = 5,na.rm = TRUE, main = " ")$graph +
  geom_hline(yintercept = 0, colour = "grey60", linetype = 2)+
  theme_tufte()  +
  labs(title = " ",
              subtitle = "Commitment",
...
stargazer(tmod1.1stage,
          tmod1.1,tmod1.2,reg_iv1,
          tmod2.1,tmod2.2,reg_iv2,
          tmod3.1,tmod3.2,reg_iv3,
          type="html",
          style = "apsr",
          ...
          covariate.labels=c(
            ...
            "Industry",
            "NGO",
            "Support for pesticides * Ban pesticide",
            "Industry * Ban pesticide",
            "NGO * Ban pesticide"),
          initial.zero = FALSE,
          out="x.htm")
